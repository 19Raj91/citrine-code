...
@Component({
  selector: 'app-mobile-appointment-form',
  templateUrl: './mobile-appointment-form.component.html',
  styleUrls: ['./mobile-appointment-form.component.scss']
})
export class MobileAppointmentFormComponent implements OnInit {
